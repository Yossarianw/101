...
def ibip(im, inlets=inlets, dt=None, maxiter=1000):
    ...
    ip = ps.filters.ibip(im=im, inlets=inlets, maxiter=340)

    fig, ax = plt.subplots(1, 1, figsize=[6, 6])
    ax.imshow(ip.inv_sequence/im, origin='lower')
    ax.axis(False);
    
    ip = ps.filters.ibip(im=im, inlets=inlets, maxiter=350)

    fig, ax = plt.subplots(1, 1, figsize=[6, 6])
    ax.imshow(ip.inv_sequence/im, origin='lower')
    ax.axis(False);
    
    ip = ps.filters.ibip(im=im, inlets=inlets, maxiter=360)

    fig, ax = plt.subplots(1, 1, figsize=[6, 6])
    ax.imshow(ip.inv_sequence/im, origin='lower')
    ax.axis(False);
    
    ip = ps.filters.ibip(im=im, inlets=inlets, maxiter=370)

    fig, ax = plt.subplots(1, 1, figsize=[6, 6])
    ax.imshow(ip.inv_sequence/im, origin='lower')
    ax.axis(False);
    
    ip = ps.filters.ibip(im=im, inlets=inlets, maxiter=380)

    fig, ax = plt.subplots(1, 1, figsize=[6, 6])
    ax.imshow(ip.inv_sequence/im, origin='lower')
    ax.axis(False);
    
    ip = ps.filters.ibip(im=im, inlets=inlets, maxiter=390)

    fig, ax = plt.subplots(1, 1, figsize=[6, 6])
    ax.imshow(ip.inv_sequence/im, origin='lower')
    ax.axis(False);
    
    ip = ps.filters.ibip(im=im, inlets=inlets, maxiter=400)

    fig, ax = plt.subplots(1, 1, figsize=[6, 6])
    ax.imshow(ip.inv_sequence/im, origin='lower')
    ax.axis(False);
    
    ip = ps.filters.ibip(im=im, inlets=inlets, maxiter=410)

    fig, ax = plt.subplots(1, 1, figsize=[6, 6])
    ax.imshow(ip.inv_sequence/im, origin='lower')
    ax.axis(False);
    
    ip = ps.filters.ibip(im=im, inlets=inlets, maxiter=420)

    fig, ax = plt.subplots(1, 1, figsize=[6, 6])
    ax.imshow(ip.inv_sequence/im, origin='lower')
    ax.axis(False);
    
    ip = ps.filters.ibip(im=im, inlets=inlets, maxiter=430)

    fig, ax = plt.subplots(1, 1, figsize=[6, 6])
    ax.imshow(ip.inv_sequence/im, origin='lower')
    ax.axis(False);
    
    ip = ps.filters.ibip(im=im, inlets=inlets, maxiter=440)
