...
im = ps.filters.trim_disconnected_blobs(im=im, inlets=inlets)
dt = edt(im)

out = ps.filters.ibip(im=im, inlets= inlets, maxiter=15000)
...
mio = ps.filters.porosimetry(im=im, inlets=inlets, sizes=sizes, mode='mio')
