# -*- coding: utf-8 -*-
"""
Created on Mon Jul 25 10:31:52 2022
...
np.random.seed(5)
im = ps.generators.blobs(shape=[500, 500], porosity=0.18, blobiness=0.002)
...
ax.step(np.array(np.log10(e.pc)), e.snwp, 'r--', where='post', markersize=20, linewidth=3, alpha=0.18, label='MIO')
